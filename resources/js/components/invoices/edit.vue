...
const SubTotal = () => {
    ...
    if (form.value.invoice_items) {
        form.value.invoice_items.map((data) => {
            total += (data.quantity != null ? data.quantity : 0) * data.unit_price;
        })
    }
...
const Total = () => {
    if (form.value.invoice_items) {
        return (SubTotal() >= form.value.discount ? SubTotal() - form.value.discount : 0);
    }
            ...
            <div class="card__content">
                ...
                <div class="table">
                    ...
                    <div class="table--items2" v-for="(itemcart, i) in form.invoice_items" :key="itemcart.id">
                        ...
                        <p>
                            <input type="number" class="input" min="0" v-model="itemcart.quantity" />
                        </p>
                        <p>$ {{ isNaN(itemcart.quantity) ? 0 : itemcart.quantity * itemcart.unit_price }}</p>
                ...
                <div class="table__footer">
                    ...
                    <div>
                        ...
                        <div class="table__footer--discount">
                            <p>Discount</p>
                            <input type="number" class="input" min="0" v-model="form.discount" />
                        </div>
            ...
            <div class="modal__content">
                ...
                <div class="modal__items">
                    <ul style="list-style: none;">
                        <li v-for="(item, i) in listProducts" :key="item.id" style="
                            display: grid;
